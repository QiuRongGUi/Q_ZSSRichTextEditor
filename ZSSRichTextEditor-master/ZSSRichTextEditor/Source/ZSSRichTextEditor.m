...
- (void)viewDidLoad {
    ...
    self.imageBase64String = [NSMutableString stringWithCapacity:0];
...
//    NSString *strings1 = [self.editorView stringByEvaluatingJavaScriptFromString:@"document.body.innerHTML"];
//    NSString *strings2 = [self.editorView stringByEvaluatingJavaScriptFromString:@"document.head.innerHTML"];
//    NSString *str = [NSString stringWithFormat:@"%@%@",strings1,strings2];
//    
//    NSLog(@"%@--",str);
//    
...
//    NSString *strings2 = [self.webView stringByEvaluatingJavaScriptFromString:@"document.head.innerHTML"];
//    
////    //    这里获得的strings为word文档内容的html格式。
////    indestr_body = [NSString stringWithFormat:@"<body>%@</body>",strings1];
////    indestr_head = [NSString stringWithFormat:@"<head>%@</head>",strings2];
//    
//
//    
//}
...
//    } else {
//        [self updateImageBase64String:imageBase64String alt:self.selectedImageAlt];gn
//    }
...
//    self.imageBase64String = imageBase64String;
    NSString *TempStr = [NSString stringWithFormat:@"%@%@%@",@"<img src =\"data:image/jpeg;base64,",imageBase64String,@"\"\r\nalt=\"(null)\">"];
    [self.imageBase64String appendString:TempStr];
